...
if __name__ == '__main__':
    ...
    length_of_initial_key = 8
    sample_size_ch_mismatch = 16
    rep = 10 # times for repeating the key agreement
    ...
    for _ in range(rep):
        ...
        ch_mismatch = (1 - np.random.rand(1))*.2 # a random number between 0 & 0.2.    
        ...
        # Dop the uncertain bits. I.e. the bits with index in "bits2drop".
